...
<div class="row verificacion-usuario">
    ...
    <div class="row formulario-inicio">
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <input id="usuario" class="form-control" type="text" placeholder="Nombre_Usuario" required>
            <br>
    ...
    <form class="row crear-usuario">
        ...
        <div class="col-md-12 col-lg-6 mt-3">
            ...
            <input name="cedula" id="cedula" class="form-control" type="number" placeholder="112233445" min="100000000" max="999999999" required>
        </div>
        <div class="col-md-12 col-lg-6 mt-3">
        ...
        <div class="col-md-12 col-lg-6 mt-3">
            ...
            <input name="apellido1" id="apellido1" class="form-control" type="text" placeholder="Apellido1" required>
        </div>
        <div class="col-md-12 col-lg-6 mt-3">
        ...
        <div class="col-md-12 col-lg-6 mt-3">
            ...
            <input name="correo" id="correo" class="form-control" type="email" placeholder="ejemplo@correo.com" required>
        </div>
        <div class="col-md-12 col-lg-6 mt-3">
        ...
        <div class="col-md-12 confirmacion mt-4">
            <div class="mb-3 form-check d-block">
                <label class="form-check-label" for="exampleCheck1"><input name="confirmacion" id="confirmacion" type="checkbox" class="form-check-input" required>
